...
opts.Add(BoolVariable("use_streamline", "Enable NVIDIA Streamline support (DLSS, Reflex; Windows only)", True))
...
if env["use_streamline"]:
    # Streamline ships as Windows-only DLLs that are loaded at runtime.
